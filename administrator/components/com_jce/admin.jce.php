...
if( !JCEHelper::checkPlugins() ){
	$mainframe->redirect( 'index.php?option=com_jce&redirected=1', JText::_('The plugins database was not created during install. Click the Fix Installation button below to complete the installation.') );
}
