...
<div class="col width-60">
	...
	<table class="admintable">
        ...
        <tr>
			...
			<td>
				<input class="text_area" type="text" name="icon" id="icon" size="35" value="<?php echo $this->plugin->icon; ?>" />.gif
			</td>
		</tr>
        <tr>
			<td valign="top" class="key">
			...
			<td>
				<input class="text_area" type="text" name="layout" id="layout" size="35" value="<?php echo $this->plugin->layout; ?>" />.gif
			</td>
		</tr>
		<tr>
			<td valign="top" class="key">
...
<div class="col width-40">
	...
	<?php
		...
		echo $pane->startPanel(JText :: _('PARAMS STANDARD'), "param-page");
		...
		if ($this->params->getNumParams('advanced')) {
			echo $pane->startPanel(JText :: _('PARAMS ADVANCED'), "advanced-page");
		...
		if ($this->params->getNumParams('defaults')) {
			echo $pane->startPanel(JText :: _('PARAMS DEFAULTS'), "defaults-page");
		...
		if ($this->params->getNumParams('access')) {
			echo $pane->startPanel(JText :: _('PARAMS ACCESS'), "access-page");
