...
<?php
	...
	$link = JRoute::_( 'index.php?option=com_jce&type=plugin&view=plugin&client='. $this->client .'&task=edit&cid[]='. $row->id );
...
?>
	<tr class="<?php echo "row$k"; ?>">
		...
		<td align="center">
			<?php echo JCEHelper::getAccessName( $row->access );?>
		</td>
		<td nowrap="nowrap">
			<?php echo $row->type;?>
		</td>
    ...
    <input type="hidden" name="accessall" value="" />
