...
/* menu overrides */
#horiz-menu li.blue-sfHover a, #horiz-menu li.blue-sfHover .separator {border-top: 5px solid #0D507A;color: #0D507A;line-height: 36px;height: 36px;}
#horiz-menu li.blue-sfHover li a:hover {color: #0D507A;}
#horiz-menu li.red-sfHover a, #horiz-menu li.red-sfHover .separator {border-top: 5px solid #D12E2E;color: #D12E2E;line-height: 36px;height: 36px;}
#horiz-menu li.red-sfHover li a:hover{color: #D12E2E;}
#horiz-menu li.purple-sfHover a, #horiz-menu li.purple-sfHover .separator {border-top: 5px solid #9E0E87;color: #9E0E87;line-height: 36px;height: 36px;}
#horiz-menu li.purple-sfHover li a:hover {color: #9E0E87;}
#horiz-menu li.green-sfHover a, #horiz-menu li.green-sfHover .separator {border-top: 5px solid #74A824;color: #74A824;line-height: 36px;height: 36px;}
#horiz-menu li.green-sfHover li a:hover {color: #74A824;}
#horiz-menu li.orange-sfHover a, #horiz-menu li.orange-sfHover .separator  {border-top: 5px solid #CC8300;color: #CC8300;line-height: 36px;height: 36px;}
#horiz-menu li.orange-sfHover li a:hover {color: #CC8300;}
#horiz-menu li.brown-sfHover a, #horiz-menu li.brown-sfHover .separator {border-top: 5px solid #8B6846;color: #8B6846;line-height: 36px;height: 36px;}
#horiz-menu li.brown-sfHover li a:hover {color: #8B6846;}
#horiz-menu li.grey-sfHover a, #horiz-menu li.grey-sfHover .separator {border-top: 5px solid #000;color: #000;line-height: 36px;height: 36px;}
#horiz-menu li.grey-sfHover li a:hover {color: #000;}
