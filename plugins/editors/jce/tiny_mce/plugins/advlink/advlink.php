...
// Load Languages
$advlink->loadLanguages();

// Setup XHR callback functions 
$advlink->setXHR( array( &$advlink, 'getLinks' ) );

// Process any XHR requests
$advlink->processXHR();
// Set javascript file array
$advlink->script( array( 
	'tiny_mce_popup', 
), 'tiny_mce' );
$advlink->script( array( 
	'tiny_mce_utils',
...
$advlink->script( array( 'advlink' ), 'plugins' );
// Set css file array
$advlink->css( array( 'common' ) );
$advlink->css( array( 'advlink' ), 'plugins' );
			...
			<fieldset>
				...
				<table border="0" cellpadding="4" cellspacing="0">
					...
					<tr>
						...
						<td colspan="3">
						<select id="classlist" name="classlist" onChange="AdvLinkDialog.setClass(this.value);">
							<option value="" selected><?php echo JText::_('NOT SET');?></option>
						</select>
						</td>
					</tr>
				</table>
