var AdvLinkDialog = {
	...
	getList : function(type, id){
		...
		if(type){
			...
			advlink.json('getLinks', [type, id], function(o){			
				onchange = !o.next ? 'AdvLinkDialog.insertLink(this.value);' : 'AdvLinkDialog.getList(\''+ o.next +'\', this.value);';
