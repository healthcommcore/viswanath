		...
		function initManager(src){
			...
			var imgmanager = new ImageManager(src, {
				...
				params: {
					...
					// Default values
					defaults : {	
						'align': 		'<?php echo $params->get( 'align', 'left' );?>',
						'border': 		'<?php echo $params->get( 'border', '0' );?>',
						'border_width': '<?php echo $params->get( 'border_width', '1' );?>',
						'border_style': '<?php echo $params->get( 'border_style', 'solid' );?>',
						'border_color': '<?php echo $params->get( 'border_color', '#000000' );?>',
						'hspace': 		'<?php echo $params->get( 'hspace', '5' );?>',
						'vspace': 		'<?php echo $params->get( 'vspace', '5' );?>'	
					}
				} 
			});
			// return object
