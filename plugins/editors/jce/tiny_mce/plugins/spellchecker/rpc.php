...
$spellchecker 	=& JContentEditor::getInstance();
$params			= $spellchecker->getPluginParams();

$config = array(
	'general.engine' 		=> $params->get( 'engine', 'GoogleSpell' ),
	// PSpell settings
	'PSpell.mode'			=> $params->get( 'pspell-mode', 'PSPELL_FAST' ),
	'PSpell.spelling'		=> $params->get( 'pspell-spelling', '' ),
	'PSpell.jargon'			=> $params->get( 'pspell-jargon', '' ),
	'PSpell.encoding'		=> $params->get( 'pspell-encoding', '' ),
	// PSpellShell settings
	'PSpellShell.mode' 		=> $params->get( 'pspellshell-mode', 'PSPELL_FAST' ),
	'PSpellShell.aspell' 	=> $params->get( 'pspellshell-aspell', '/usr/bin/aspell' ),
	'PSpellShell.tmp' 		=> $params->get( 'pspellshell-tmp', '/tmp' )
);

require_once( dirname(__FILE__) .DS. "classes/" . $config['general.engine'] . ".php");
