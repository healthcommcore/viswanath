	...
	*/
	function __construct(){		
		...
		if( JRequest::getVar( 'type', 'file' ) == 'file'){
			$this->setFileTypes( $this->_params->get( 'extensions', 'html,htm,doc,rtf,xls,txt,gif,jpeg,jpg,png,pdf,zip,swf,rar,tar,gz,mov,mpeg,mpg,avi,asf,asx,dcr,flv,css,php,js,xml,wmv,wav,mp3' ) );
		} 
		$this->init();
	}
	/**
	...
	function getViewable(){
		...
		return $params->get( 'viewable', 'html,htm,doc,rtf,xls,txt,gif,jpeg,jpg,png,pdf,swf,mov,mpeg,mpg,avi,asf,asx,dcr,flv,wmv,wav,mp3' );
	}
}
