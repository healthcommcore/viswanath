...
var Alert = Dialog.extend({
    initialize: function(html, options){
		...
		this.parent('alert', tinyMCEPopup.getLang('dlg.alert', 'Alert'), html, {
			width: 300,
			height: 150,
			buttons: [{
...
var mediaPreview = basicDialog.extend({
    ...
    initialize: function(title, url, options){		
		...
		this.mediaWidth 	= this.options.width;
		this.mediaHeight 	= this.options.height;
		this.setDimensions();
	...
	setDimensions: function(){
		...
		var w = this.mediaWidth.toInt();
		var h = this.mediaHeight.toInt();
